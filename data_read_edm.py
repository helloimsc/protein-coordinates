...
from Bio.PDB import PDBIO, Atom, Chain, PDBParser, Polypeptide, Residue, Selection
...
def generate_graph(pdb_path, k=10, rbf_dim=16, sc_dim=24, sc_n=10000):
    ...
    # print(f"The shape of the frames tensor is {frames.shape}")
    # print(f"The shape of the i_seq tensor is {i_seq.shape}")
    # print(f"The shape of the forward vector is {forward.shape}")
    # print(f"The shape of the reverse vector is {reverse.shape}")
    # print(f"The shape of the side vector is {side.shape}")
